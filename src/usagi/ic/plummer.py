...
class MakePlummerModel(object):
    def __init__(self, number_of_particles, xellip=0, yellip=0, zellip=0, convert_nbody = None, radius_cutoff = 22.8042468, mass_cutoff = 1.999,
...
#        r = 1.0 /  numpy.sqrt( numpy.power(numpy.random.uniform(0,self.mass_cutoff,(self.number_of_particles,1)), -2.0/3.0) - 1.0)
